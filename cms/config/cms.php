    ...
    */
    ...
    'storage' => [
        ...
        'uploads' => [
            'disk'            => 's3',
            'folder'          => 'uploads',
            'path'            => 'https://space-software.s3.eu-central-1.amazonaws.com/uploads',
        ...
        'media' => [
            'disk'   => 's3',
            'folder' => 'media',
            'path'   => 'https://space-software.s3.eu-central-1.amazonaws.com/media'
        ],

        'resized' => [
            'disk'   => 's3',
            'folder' => 'resized',
            'path'   => 'https://space-software.s3.eu-central-1.amazonaws.com/resized'
        ]
